...
<?/*	<th><?php echo $paginator->sort('resource_path');?></th>	*/?>
...
<?/*		<td><?php echo $note['Note']['user_id']; ?></td>	*/?>
<?/*		<td><?php echo $note['Note']['topic_id']; ?></td>	*/?>
		<td><?php echo $note['Note']['title']; ?></td>
		<td><?php echo $note['Note']['description']; ?></td>
<?/*		<td><?php echo $note['Note']['resource_path']; ?></td>	*/?>
		<td><?php echo substr(strip_tags($note['Note']['body']), 0, 50)."..."; ?></td>
		<td><?php echo $note['Note']['created']; ?></td>	
<?/*		<td><?php echo $note['Note']['modified']; ?></td>	*/?>
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action'=>'viewpluscomment', $note['Note']['id'])); ?>
